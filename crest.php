...
#print_r($arPost);
	...
	private static function getAppSettings()
	{
        ...
        /*if(defined("C_REST_WEB_HOOK_URL") && !(C_REST_WEB_HOOK_URL == ''))
		{
			$arData = [
