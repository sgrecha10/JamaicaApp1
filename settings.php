<?php
define('C_REST_CLIENT_ID','local.5f2988f3696ca1.52059493');//Application ID 
define('C_REST_CLIENT_SECRET','iFZPJ49ODobqoYngNxcQPt2T8mTNjFz26wrnK3hv0uyVdSj7zJ');//Application key
// or
